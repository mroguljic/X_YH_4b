...
for year in ["16","17","18"]:
    for sample in ["QCD","TTbar"]:
        ...
        compareShapes(hMJJ_T_AL,hMJJ_TT,"MJJ_TT_{0}_{1}.png".format(year,sample),xTitle="$M_{JJ}$ [GeV]",yTitle="Event fraction/100GeV",label1="T_AL",label2="TT",labelR="TT/T_AL",yRange=[0,0.7],xRange=[],log=False,data=False,text="{0}\nWPs = {1}, {2}".format(sample, wps[0],wps[1]),year="20{0}".format(year))
        compareShapes(hMJJ_L_AL,hMJJ_LL,"MJJ_LL_{0}_{1}.png".format(year,sample),xTitle="$M_{JJ}$ [GeV]",yTitle="Event fraction/100GeV",label1="L_AL",label2="LL",labelR="LL/L_AL",yRange=[0,0.7],xRange=[],log=False,data=False,text="{0}\nWPs = {1}, {2}".format(sample, wps[0],wps[1]),year="20{0}".format(year))

        compareShapes(hMJY_T_AL,hMJY_TT,"MJY_TT_{0}_{1}.png".format(year,sample),xTitle="$M_{JY}$ [GeV]",yTitle="Event fraction/20GeV",label1="T_AL",label2="TT",labelR="TT/T_AL",yRange=[0,0.7],xRange=[],log=False,data=False,text="{0}\nWPs = {1}, {2}".format(sample, wps[0],wps[1]),year="20{0}".format(year))
        compareShapes(hMJY_L_AL,hMJY_LL,"MJY_LL_{0}_{1}.png".format(year,sample),xTitle="$M_{JY}$ [GeV]",yTitle="Event fraction/20GeV",label1="L_AL",label2="LL",labelR="LL/L_AL",yRange=[0,0.7],xRange=[],log=False,data=False,text="{0}\nWPs = {1}, {2}".format(sample, wps[0],wps[1]),year="20{0}".format(year))
