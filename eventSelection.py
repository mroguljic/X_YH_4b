...
h_mjY_total = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_tot'.format(options.process),'FatJetY mSD;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_total = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_tot'.format(options.process),'FatJetH mSD;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
...
newcolumns.Add("pnet_ATT","FatJet_ParticleNetMD_probXbb[idxH] > {0} && FatJet_ParticleNetMD_probXbb[idxY]<{1}".format(pnet_T,pnet_L))#Anti-tag (H) Tight (Y)
newcolumns.Add("pnet_ALL","FatJet_ParticleNetMD_probXbb[idxH] > {0} && FatJet_ParticleNetMD_probXbb[idxY]<{0} && (!pnet_ATT)".format(pnet_L))#Anti-tag (H) Loose (Y)
...
newcolumns.Add("dak8_ATT","FatJet_deepTagMD_ZHbbvsQCD[idxH] > {0} && FatJet_deepTagMD_ZHbbvsQCD[idxY]<{1}".format(dak8_T,dak8_L))
newcolumns.Add("dak8_ALL","FatJet_deepTagMD_ZHbbvsQCD[idxH] > {0} && FatJet_deepTagMD_ZHbbvsQCD[idxY]<{0} && (!dak8_ATT)".format(dak8_L))
...
h_mjY_pnet_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_pnet_TT'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_pnet_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_pnet_TT'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_pnet_TT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_pnet_TT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
...
h_mjY_pnet_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_pnet_LL'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_pnet_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_pnet_LL'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_pnet_LL = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_pnet_LL'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
...
h_mjY_pnet_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_pnet_ATT'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_pnet_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_pnet_ATT'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_pnet_ATT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_pnet_ATT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
h_ptjY_pnet_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_pnet_ATT'.format(options.process),'FatJetY pt;pT_Y [GeV];Events / 10 GeV;',300,0,3000),'ptjY')
h_ptjH_pnet_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_pnet_ATT'.format(options.process),'FatJetH pt;pT_H [GeV];Events / 10 GeV;',300,0,3000),'ptjH')
histos.append(h_ptjY_pnet_ATT)
histos.append(h_ptjH_pnet_ATT)
histos.append(h_mjY_pnet_ATT)
histos.append(h_mjH_pnet_ATT)
histos.append(h_mjH_mjjHY_pnet_ATT)

a.SetActiveNode(checkpoint)
a.Cut("pnet_ALL","pnet_ALL==1")
h_mjY_pnet_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_pnet_ALL'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_pnet_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_pnet_ALL'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_pnet_ALL = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_pnet_ALL'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
h_ptjY_pnet_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_pnet_ALL'.format(options.process),'FatJetY pt;pT_Y [GeV];Events / 10 GeV;',300,0,3000),'ptjY')
h_ptjH_pnet_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_pnet_ALL'.format(options.process),'FatJetH pt;pT_H [GeV];Events / 10 GeV;',300,0,3000),'ptjH')
histos.append(h_ptjY_pnet_ALL)
histos.append(h_ptjH_pnet_ALL)
histos.append(h_mjY_pnet_ALL)
histos.append(h_mjH_pnet_ALL)
...
h_mjY_dak8_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_dak8_TT'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_dak8_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_dak8_TT'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_dak8_TT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_dak8_TT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
...
h_mjY_dak8_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_dak8_LL'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_dak8_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_dak8_LL'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_dak8_LL = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_dak8_LL'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
...
h_mjY_dak8_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_dak8_ATT'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_dak8_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_dak8_ATT'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_dak8_ATT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_dak8_ATT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
h_ptjY_dak8_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_dak8_ATT'.format(options.process),'FatJetY pt;pT_Y [GeV];Events / 10 GeV;',300,0,3000),'ptjY')
h_ptjH_dak8_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_dak8_ATT'.format(options.process),'FatJetH pt;pT_H [GeV];Events / 10 GeV;',300,0,3000),'ptjH')
histos.append(h_ptjY_dak8_ATT)
histos.append(h_ptjH_dak8_ATT)
histos.append(h_mjY_dak8_ATT)
histos.append(h_mjH_dak8_ATT)
histos.append(h_mjH_mjjHY_dak8_ATT)

a.SetActiveNode(checkpoint)
a.Cut("dak8_ALL","dak8_ALL==1")
h_mjY_dak8_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjY_dak8_ALL'.format(options.process),'FatJetY softdrop mass;mSD_Y [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_mjH_dak8_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_mjH_dak8_ALL'.format(options.process),'FatJetH softdrop mass;mSD_H [GeV];Events / 10 GeV;',100,0,1000),'mjH')
h_mjH_mjjHY_dak8_ALL = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_dak8_ALL'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',100,0,1000,100,0,1000,300,0,3000),'mjY','mjH','mjjHY')
h_ptjY_dak8_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_dak8_ALL'.format(options.process),'FatJetY pt;pT_Y [GeV];Events / 10 GeV;',300,0,3000),'ptjY')
h_ptjH_dak8_ALL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_dak8_ALL'.format(options.process),'FatJetH pt;pT_H [GeV];Events / 10 GeV;',300,0,3000),'ptjH')
histos.append(h_ptjY_dak8_ALL)
histos.append(h_ptjH_dak8_ALL)
histos.append(h_mjY_dak8_ALL)
histos.append(h_mjH_dak8_ALL)
histos.append(h_mjH_mjjHY_dak8_ALL)

a.SetActiveNode(checkpoint)
a.Cut("genJetIdx","idx_GenJetH>=0 && idx_GenJetY>=0")
h_genJetMassH = a.GetActiveNode().DataFrame.Histo1D(('{0}_genJetM_H'.format(options.process),'GenJetH softdrop mass;Gen jet H mSD [GeV];Events / 10 GeV;',100,0,1000),'GenJetH_mass')
h_genJetMassY = a.GetActiveNode().DataFrame.Histo1D(('{0}_genJetM_Y'.format(options.process),'GenJetY softdrop mass;Gen jet Y mSD [GeV];Events / 10 GeV;',100,0,1000),'GenJetY_mass')
h_recoJetMassY = a.GetActiveNode().DataFrame.Histo1D(('{0}_recoJetM_Y'.format(options.process),'RecoJetY softdrop mass;Reco jet H mSD [GeV];Events / 10 GeV;',100,0,1000),'mjY')
h_recoJetMassH = a.GetActiveNode().DataFrame.Histo1D(('{0}_recoJetM_H'.format(options.process),'RecoJetH softdrop massReco jet Y mSD [GeV];Events / 10 GeV;',100,0,1000),'mjH')
