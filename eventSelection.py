...
h_ptjY_total = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_tot'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_total = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_tot'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_selection = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_sel'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_selection = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_sel'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_pnet_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_pnet_TT'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_pnet_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_pnet_TT'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_pnet_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_pnet_LL'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_pnet_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_pnet_LL'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_pnet_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_pnet_ATT'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_pnet_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_pnet_ATT'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_pnet_ATL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_pnet_ATL'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_pnet_ATL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_pnet_ATL'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
histos.append(h_ptjY_pnet_ATL)
histos.append(h_ptjH_pnet_ATL)
...
h_ptjY_dak8_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_dak8_TT'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_dak8_TT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_dak8_TT'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_dak8_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_dak8_LL'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_dak8_LL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_dak8_LL'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_dak8_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_dak8_ATT'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_dak8_ATT = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_dak8_ATT'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
...
h_ptjY_dak8_ATL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjY_dak8_ATL'.format(options.process),'FatJetY pt',150,0,1500),'ptjY')
h_ptjH_dak8_ATL = a.GetActiveNode().DataFrame.Histo1D(('{0}_ptjH_dak8_ATL'.format(options.process),'FatJetH pt',150,0,1500),'ptjH')
histos.append(h_ptjY_dak8_ATL)
histos.append(h_ptjH_dak8_ATL)
