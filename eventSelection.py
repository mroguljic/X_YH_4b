...
h_mjH_mjjHY_pnet_TT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_pnet_TT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',30,30,330,30,30,330,250,750,3250),'mjY','mjH','mjjHY')
...
h_mjH_mjjHY_pnet_LL = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_pnet_LL'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',30,30,330,30,30,330,250,750,3250),'mjY','mjH','mjjHY')
...
h_mjH_mjjHY_pnet_AT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_pnet_AT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',30,30,330,30,30,330,250,750,3250),'mjY','mjH','mjjHY')
...
h_mjH_mjjHY_dak8_TT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_dak8_TT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',30,30,330,30,30,330,250,750,3250),'mjY','mjH','mjjHY')
...
h_mjH_mjjHY_dak8_LL = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_dak8_LL'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',30,30,330,30,30,330,250,750,3250),'mjY','mjH','mjjHY')
...
h_mjH_mjjHY_dak8_AT = a.GetActiveNode().DataFrame.Histo3D(('{0}_mjY_mjH_mjjHY_dak8_AT'.format(options.process),'mjY vs mjH vs mjjHY;mSD_Y [GeV];mSD_H [GeV];Invariant dijet mass [GeV]',30,30,330,30,30,330,250,750,3250),'mjY','mjH','mjjHY')
