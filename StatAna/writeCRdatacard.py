...
shapes TTbar_qq REGION_CR\t PATH/TTbarYEAR.root\t $PROCESS_mSD_REGION_nom $PROCESS_mSD_REGION_$SYSTEMATIC
shapes TTbar_bq REGION_CR\t PATH/TTbarYEAR.root\t $PROCESS_mSD_REGION_nom $PROCESS_mSD_REGION_$SYSTEMATIC
shapes TTbar_unmatched REGION_CR\t PATH/TTbarYEAR.root\t $PROCESS_mSD_REGION_nom $PROCESS_mSD_REGION_$SYSTEMATIC
shapes data_obs\t REGION_CR\t PATH/SingleMuonYEAR.root\t data_obs_mSD_REGION
shapes sig\t   REGION_CR\t    /afs/cern.ch/work/m/mrogulji/UL_X_YH/X_YH_4b/misc/fakeSignal.root\t mSD_CR mSD_CR
------------------------------------------------------------'''

# procs = ["TTbar","ST","WJets"]
# jetCats = ["bqq","bq","qq","unmatched"]
procs = ["sig","TTbar","Other"]
jetCats = ["bqq","bq"]
processes = {}
rateParams=""
i = 0
...
uniShapeUncs = ["jer","jes","jms","jmr","id","iso","trig","sf"]
uncLines = ""
...
for p in sortedProcs:
    ...
    pdfline +="1.01\t"
    prefline+="1.02\t"
normLines = "\n".join([lumiline,puline,pdfline])
topxsecline  = "topxsec\tlnN\t-\t1.061/0.938\t1.061/0.938\t-"
...
nuisance edit rename TTbar_bqq REGION_CR jmr jmrAK8_bqqYEAR
nuisance edit rename TTbar_bq REGION_CR jmr jmrAK8_bqYEAR
nuisance edit rename Other REGION_CR jmr jmrAK8_OtherYEAR
